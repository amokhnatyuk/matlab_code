% sweep_cbgain2 procedure
dirSave = 'C:\data\raijin_lot3\cbtest';
if ~exist(dirSave, 'dir') mkdir(dirSave); end
copyfile('sweep_cbgain2.m',dirSave);  % copy this file to dst folder
...
for kk=1:length(gain_ind)
    ...
    for ii = 1:dac_seq_sz
        ...
        swp1 = vsweep44(dacCode, s2, dir_gain);
        vpga = swp1.d(1,1,2);
...
%    save ([dirSave, prefix, '.mat'], 'out1');
    save ([dirSave, prefix, '.mat'], 'out1', '-v7.3');
