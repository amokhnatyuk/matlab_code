dirSave = 'C:\data\lot1_\adcbias_oldBG\adc_delay\pgadly\';
...
for ii = 1:dac_seq_sz
    ...
    prefix2 = ['bias=', num2str(adcbias),' pgadly_swp', ' adcdly=', num2str(adcdly),' Vpga=',num2str(vpga,'%5.1f'),'mV'];
    save ([dirSave, prefix2, '.mat'], 'out1');
    figNum = 90;
    sweepPlot43(out1, figNum, dirSave, prefix2,'pga');
end
