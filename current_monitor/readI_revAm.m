...
d{1,3} = 'VDD-MPHY 1.2V'; % R229, read U21 V1/2 VDD_MPHY 1.2V (schematics VDD_DIG_MPHY)
d{2,1} = '900010'; d{2,2} = '900011';
d{2,3} = 'VDDIO-DIG 1.8V'; % R43, read U21 V3/4 VDDIO_DIG 1.8V
...
d{6,3} = 'VDDA-MPHY 1.2V';  % R104, read VDDA_MPHY 1.2V U20 V3/4 ( schematics VDDA_36_VERT 3.6V )
d{7,1} = '920014'; d{7,2} = '920015'; 
d{7,3} = 'VDDA-33 3.3V'; % R86, read 1.2V U20 V5/6  VDDA_33 3.3V
d{8,1} = '920018'; d{8,2} = '920019'; 
d{8,3} = 'VDDA-12 1.25V'; % R648, read device U20 V7/8 VDDA_12 1.25V

d{9,1} = '94000C'; d{9,2} = '94000D'; 
d{9,3} = 'VDDA-PLL 3.3V'; % R80, read U22 V1/2 VDDA_PLL 3.3V
...
d{13,3} = 'VDDA-PLL-MPHY + VDD-PLL-MPHY 1.2V'; % R121, read VDDA_PLL_MPHY + VDD_PLL_MPHY U18 V1/2 ( schematics VRSTHIGH )
d{14,1}= '960010'; d{14,2}= '960011'; 
d{14,3} = 'VDD-DIG 1.2V'; % R1, read VDD_DIG 1.2V device U18 V3/4 (schematics VTXHIGH )
