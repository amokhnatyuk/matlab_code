dirSave = 'C:\data\lot1_\all_adc\tmp\';
copyfile('sweepV_mf1.m',dirSave);  % copy this file to dst folder

% initial setup
writeSensorReg( '090a0001', s2);  pause(0.1);  % set new adc bias generator    
writeEvkDacReset( s2);
...
figNum = 191;
sweepPlot46(out1, figNum, dirSave, prefix);
